...
export default function AdminSlidersPage() {
  ...
  const handleAdd = () => {
    setFormData({ imageUrl: "", displayOrder: 0, isActive: true });
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingSlider) {
        await sliderService.updateSlider(editingSlider.id, formData as UpdateSliderRequest);
      ...
      toast.error(error.response?.data?.message || "Lỗi khi lưu slider");
    }
  };
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || "Lỗi khi xóa slider");
    }
  };
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            <p className="text-gray-600">Đang tải danh sách slider...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Quản lý Slider</h1>
            <p className="text-gray-600">Quản lý tất cả slider trên trang chủ</p>
          </div>
          <button
            onClick={handleAdd}
                ...
                {sliders.map((slider) => (
                  <tr key={slider.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        {slider.isActive ? "Hoạt động" : "Vô hiệu hóa"}
                      </span>
                    </td>
        ...
        {sliders.length === 0 && (
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <p className="text-gray-600">Chưa có slider nào.</p>
          </div>
        )}
